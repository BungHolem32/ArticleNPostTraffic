...
namespace DoctrineProxies\__CG__\App\Http\Entities;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Author extends \App\Http\Entities\Author implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'articles'];
        }
     ...
     * {@inheritDoc}
     */
    public function setArticle(\App\Http\Entities\Article $article)
    {
